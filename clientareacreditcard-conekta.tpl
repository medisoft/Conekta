    ...
    <form class="form-horizontal" action="" method="POST" id="payment-form">
        ...
        <fieldset class="onecol">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    {*<input type="text" size="20" data-conekta="card[name]" value="{$name}"/>*}
                    <input type="text" size="20" autocomplete="off" class="cardholder-name" data-conekta="card[name]" value="{$name}"/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" class="cardholder-address-l1" data-conekta="card[address][street1]" value="{$address1}"/><br/><br/>

                    {*<input type="text" size="25" data-conekta="card[address][street1]"/>*}
                    <input type="text" size="20" autocomplete="off" class="cardholder-address-l2" data-conekta="card[address][street2]" value="{$address2}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" class="cardholder-city" data-conekta="card[address][city]" value="{$city}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" class="cardholder-state" data-conekta="card[address][state]" value="{$state}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" class="cardholder-country" data-conekta="card[address][country]" value="{$country}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" class="cardholder-zip" data-conekta="card[address][zip]" value="{$zipcode}"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="20" autocomplete="off" data-conekta="card[number]" class="card-number"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="4" autocomplete="off" data-conekta="card[cvc]" class="card-cvc input-mini"/>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" size="2" data-conekta="card[exp_month]" class="card-expiry-month input-mini"/> / <input type="text" size="4" data-conekta="card[exp_year]"
